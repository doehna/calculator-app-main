...
function addEqualButtonEventListener(screen) {
    ...
    equalButton.addEventListener("click", function() {
        (0, _calculate.calculateResult)(screen);
        _localStorage.clear();
    });
}
function addActionButtonsEventListeners(screen) {
    ...
    for (const button of buttons)button.addEventListener("click", function(e) {
        (0, _calculate.calculateResult)(screen);
        _localStorage.setAction(e.target.textContent);
    });
}
function addButtonsEventListener(screen) {
    ...
    for (const button of buttons)button.addEventListener("click", function() {
        _screen.addCharacter(screen, button);
    });
}
...
function addDeleteButtonEventListener(screen) {
    ...
    resetButton.addEventListener("click", function() {
        ...
        _localStorage.setIsSubmitted("false");
    });
}
function addRadioButtonsClickListeners() {
    ...
    for (const radioButton of radioButtons)radioButton.addEventListener("click", function() {
        _theme.changeColor(this.id);
        _theme.setTogglePosition(this.id);
    });
}

},{"./calculate":"cfhVV","./localStorage":"45bAM","./theme":"bTBbp","./screen":"8hs3a"}],"cfhVV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "calculateResult", ()=>calculateResult);
var _localStorage = require("./localStorage");
function calculateResult(screen) {
    // in case action button was clicked without changing the value
    let hasChanged = _localStorage.getIsSubmitted() === "false";
    let result = parseFloat(_localStorage.getResult());
    let action = _localStorage.getAction();
    let value = parseFloat(screen.innerHTML);
    value = isNaN(value) ? 0 : value;
    result = !isNaN(result) && hasChanged ? performOperation(action, result, value) : value;
    _localStorage.setIsSubmitted("true");
    _localStorage.setResult(result);
...
},{"./localStorage":"45bAM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"45bAM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getResult", ()=>getResult);
parcelHelpers.export(exports, "getAction", ()=>getAction);
parcelHelpers.export(exports, "getIsSubmitted", ()=>getIsSubmitted);
parcelHelpers.export(exports, "getTheme", ()=>getTheme);
parcelHelpers.export(exports, "setResult", ()=>setResult);
parcelHelpers.export(exports, "setAction", ()=>setAction);
parcelHelpers.export(exports, "setIsSubmitted", ()=>setIsSubmitted);
...
const setResult = (result)=>localStorage.setItem("result", result);
const setAction = (action)=>localStorage.setItem("action", action);
const setIsSubmitted = (isSubmitted)=>localStorage.setItem("isSubmitted", isSubmitted);
...
parcelHelpers.export(exports, "matchRadioButtonValue", ()=>matchRadioButtonValue);
parcelHelpers.export(exports, "setTogglePosition", ()=>setTogglePosition);
parcelHelpers.export(exports, "changeColor", ()=>changeColor);
var _localStorage = require("./localStorage");
...
function changeColor(theme) {
    ...
    _localStorage.setTheme(theme);
}
function setDefaultColor() {
    const defaultTheme = _localStorage.getTheme();
    let theme;
    if (defaultTheme) {
...
},{"./localStorage":"45bAM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8hs3a":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addCharacter", ()=>addCharacter);
var _localStorage = require("./localStorage");
function addCharacter(screen, button) {
    let value = screen.innerHTML.trim();
    let isSubmitted = _localStorage.getIsSubmitted() === "true";
    if (isSubmitted) {
...
},{"./localStorage":"45bAM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7ENHu","1Jxk5"], "1Jxk5", "parcelRequire06f1")
